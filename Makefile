PROJECT_NAME     := ble_app_blinky_adv_pca10040_s132
...
merge_softdevice: default
	mergehex -m \
		$(SDK_ROOT)/components/softdevice/s132/hex/s132_nrf52_6.1.1_softdevice.hex \
